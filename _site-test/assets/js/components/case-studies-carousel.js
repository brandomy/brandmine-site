// Case Studies Carousel JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const navContainer = document.querySelector('.universal-carousel-nav');

    if (!carousel || !navContainer) return;

    const totalCards = 4; // Total case studies from Jekyll data
    let dots = [];

    /**
     * Generate navigation dots based on screen size
     * Desktop: 2 cards per view = 2 dots
     * Mobile: 1 card per view = 4 dots
     */
    ...
    function initCarousel() {
        ...
        console.log(`Case studies carousel initialized - ${totalDots} dots for ${cardsPerView} cards per view`);
    }
