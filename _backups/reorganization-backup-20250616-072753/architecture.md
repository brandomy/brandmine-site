...
**Usage in components:**
```liquid
{% raw %}{% comment %} OLD PATTERN - Avoid {% endcomment %}
{% assign show_author = include.show_author | default: true %}
{% assign excerpt_words = include.excerpt_words | default: 25 %}{% endraw %}

{% raw %}{% comment %} NEW PATTERN - Use this {% endcomment %}
...
{% assign show_author = include.show_author | default: default_show_author %}{% endraw %}
```
...
{{ t.view_profile | default: "View Profile" }}{% endraw %}

{% raw %}{% comment %} NEW PATTERN - Use this {% endcomment %}
{% include helpers/t.html key="brands.view_profile" fallback="View Profile" %}{% endraw %}
```
...
{% unless page.sections %}
  {% assign sections_to_render = "hero,content,cta" | split: "," %}{% endraw %}
{% raw %}{% else %}
...
{% raw %}{% comment %} NEW PATTERN - Use this {% endcomment %}
{% include helpers/page-sections.html page_type="brands" content=page_content %}{% endraw %}
```
...
{% raw %}{% capture default_show_image %}{% include helpers/component-defaults.html component="cards.my-card" param="show_image" fallback=true %}{% endcapture %}{% endraw %}
...
- **Single helper pattern:** `{% raw %}{% include helpers/t.html %}{% endraw %}`
...
**Translations:** `{% raw %}{% include helpers/t.html key="path.to.key" fallback="Default" %}{% endraw %}`
**Page rendering:** `{% raw %}{% include helpers/page-sections.html page_type="page_name" %}{% endraw %}`
