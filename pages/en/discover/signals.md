  ...
  <div class="panel__content">
    ...
    <section class="signals__section">
      ...
      <div class="signals-about">
        <p class="signals-about__text">
          Growth signals help identify brands with strong potential for international expansion, investment, or partnership opportunities. These indicators are based on our proprietary analysis of market readiness, business maturity, and cross-border potential.
        </p>
        ...
        <div class="signals-about__premium">
          <div class="signals-about__premium-content">
            ...
            <div>
              <h3 class="signals-about__premium-title">Premium Feature</h3>
    ...
    <section class="signals__section">
      ...
      <div class="signal-category">
        <h3 class="signal-category__title">International Readiness</h3>
      ...
      <div class="signal-category">
        <h3 class="signal-category__title">Investment Potential</h3>
        <div class="signal-category__tags">
          {% for signal in site.data.translations[page.lang].signals %}
            {% assign slug = signal[0] %}
            {% assign name = signal[1] %}
      ...
      <!-- Market Performance -->
      <div class="signal-category">
        <h3 class="signal-category__title">Market Performance</h3>
        <div class="signal-category__tags">
          {% for signal in site.data.translations[page.lang].signals %}
            {% assign slug = signal[0] %}
            {% assign name = signal[1] %}
