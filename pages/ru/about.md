      ...
      <div class="solutions-list">
        <div class="solution-item">
          ...
          <div class="solution-content">
            <h3>Агрегирования разрозненной информации</h3>
            <p>В единые, исчерпывающие профили брендов</p>
          </div>
        </div>
        ...
        <div class="solution-item">
          ...
          <div class="solution-content">
            <h3>Перевода не только языка</h3>
            <p>Но и культурного и политического контекста</p>
          </div>
        </div>
        ...
        <div class="solution-item">
          ...
          <div class="solution-content">
            <h3>Стандартизации показателей</h3>
            <p>Для осмысленного сравнения</p>
          </div>
        </div>
        ...
        <div class="solution-item">
          ...
          <div class="solution-content">
            <h3>Раскрытия историй брендов</h3>
            <p>Выходящих за пределы отдельных рынков</p>
          </div>
        </div>
        ...
        <div class="solution-item">
          ...
          <div class="solution-content">
            <h3>Предварительной проверки возможностей</h3>
            <p>Для снижения рисков и исследовательской нагрузки</p>
          </div>
        </div>
      </div>
  </div>
        ...
        <div class="service-panel__content">
          <ul class="service-list">
            ...
            <li class="service-item">
              <span class="service-item__bullet">•</span>
              <div class="service-item__content">
                <strong class="service-item__title">Разработка повествования:</strong>
                <p>Улучшение историй брендов для трансграничного воздействия</p>
              </div>
            </li>
            <li class="service-item">
              <span class="service-item__bullet">•</span>
              <div class="service-item__content">
                <strong class="service-item__title">Оценка готовности:</strong>
                <p>Оценка готовности к экспорту и партнерству</p>
              </div>
            </li>
            <li class="service-item">
              <span class="service-item__bullet">•</span>
              <div class="service-item__content">
                <strong class="service-item__title">Возможности соединения:</strong>
                <p>Доступ к заинтересованным международным партнерам</p>
              </div>
            </li>
          </ul>
        </div>
