...
<div class="panel panel--light">
  <div class="panel__content">
    ...
    <div class="russian-sectors__introduction">
      <p class="russian-sectors__intro-text">Потребительский ландшафт российских брендов отличается исключительным разнообразием и нераскрытым международным потенциалом. Эти 16 тщательно отобранных секторов представляют собой наиболее перспективные возможности для трансграничного партнерства и инвестиций.</p>
    
      <div class="russian-sectors__columns">
        <div class="russian-sectors__column">
          <h3 class="russian-sectors__heading">Секторы образа жизни</h3>
          <ul>
            <li class="russian-sectors__item"><a href="#hotels">Отели и курорты</a></li>
            <li class="russian-sectors__item"><a href="#beauty">Натуральная косметика</a></li>
            <li class="russian-sectors__item"><a href="#jewelry">Ювелирные изделия и часы</a></li>
            <li class="russian-sectors__item"><a href="#fashion">Мода и аксессуары</a></li>
            <li class="russian-sectors__item"><a href="#porcelain">Художественный фарфор и керамика</a></li>
            <li class="russian-sectors__item"><a href="#supplements">Натуральные пищевые добавки</a></li>
          </ul>
        </div>
        
        <div class="russian-sectors__column">
          <h3 class="russian-sectors__heading">Секторы продуктов питания и напитков</h3>
          <ul>
            <li class="russian-sectors__item"><a href="#spirits">Крафтовые спиртные напитки и водка</a></li>
            <li class="russian-sectors__item"><a href="#gourmet">Деликатесы</a></li>
            <li class="russian-sectors__item"><a href="#wine">Вино</a></li>
            <li class="russian-sectors__item"><a href="#honey">Мёд и продукты пчеловодства</a></li>
            <li class="russian-sectors__item"><a href="#mineral-waters">Минеральные воды</a></li>
            <li class="russian-sectors__item"><a href="#cheese">Специальные сыры</a></li>
            <li class="russian-sectors__item"><a href="#dairy">Ферментированные молочные продукты (кефир)</a></li>
            <li class="russian-sectors__item"><a href="#halal">Халяльные продукты</a></li>
            <li class="russian-sectors__item"><a href="#meats">Колбасы и копчености</a></li>
            <li class="russian-sectors__item"><a href="#confectionery">Ремесленные кондитерские изделия</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="russian-sectors__category">
      <h2 class="russian-sectors__category-title">Секторы образа жизни</h2>
      
      <section id="hotels" class="russian-sectors__section russian-sectors__section--hotels">
        <h3 class="russian-sectors__section-title">Отели и курорты</h3>
      ...
      <section id="beauty" class="russian-sectors__section russian-sectors__section--beauty">
        <h3 class="russian-sectors__section-title">Натуральная косметика</h3>
      ...
      <section id="jewelry" class="russian-sectors__section russian-sectors__section--jewelry">
        <h3 class="russian-sectors__section-title">Ювелирные изделия и часы</h3>
      ...
      <section id="fashion" class="russian-sectors__section russian-sectors__section--fashion">
        <h3 class="russian-sectors__section-title">Мода и аксессуары</h3>
      ...
      <section id="porcelain" class="russian-sectors__section russian-sectors__section--porcelain">
        <h3 class="russian-sectors__section-title">Художественный фарфор и керамика</h3>
      ...
      <section id="supplements" class="russian-sectors__section russian-sectors__section--supplements">
        <h3 class="russian-sectors__section-title">Натуральные пищевые добавки</h3>
...
<div class="panel panel--primary-soft">
  <div class="panel__content">
    ...
    <div class="russian-sectors__category">
      <h2 class="russian-sectors__category-title">Секторы продуктов питания и напитков</h2>
      
      <section id="spirits" class="russian-sectors__section russian-sectors__section--spirits">
        <h3 class="russian-sectors__section-title">Крафтовые спиртные напитки и водка</h3>
      ...
      <section id="gourmet" class="russian-sectors__section russian-sectors__section--gourmet">
        <h3 class="russian-sectors__section-title">Деликатесы</h3>
      ...
      <section id="wine" class="russian-sectors__section russian-sectors__section--wine">
        <h3 class="russian-sectors__section-title">Вино</h3>
      ...
      <section id="honey" class="russian-sectors__section russian-sectors__section--honey">
        <h3 class="russian-sectors__section-title">Мёд и продукты пчеловодства</h3>
      ...
      <section id="mineral-waters" class="russian-sectors__section russian-sectors__section--mineral-waters">
        <h3 class="russian-sectors__section-title">Минеральные воды</h3>
      ...
      <section id="cheese" class="russian-sectors__section russian-sectors__section--cheese">
        <h3 class="russian-sectors__section-title">Специальные сыры</h3>
      ...
      <section id="dairy" class="russian-sectors__section russian-sectors__section--dairy">
        <h3 class="russian-sectors__section-title">Ферментированные молочные продукты (кефир)</h3>
      ...
      <section id="halal" class="russian-sectors__section russian-sectors__section--halal">
        <h3 class="russian-sectors__section-title">Халяльные продукты</h3>
      ...
      <section id="meats" class="russian-sectors__section russian-sectors__section--meats">
        <h3 class="russian-sectors__section-title">Колбасы и копчености</h3>
      ...
      <section id="confectionery" class="russian-sectors__section russian-sectors__section--confectionery">
        <h3 class="russian-sectors__section-title">Ремесленные кондитерские изделия</h3>
...
<div class="panel panel--light">
  <div class="panel__content">
    ...
    <div class="russian-sectors__navigation">
      <h3 class="russian-sectors__navigation-title">Исследуйте другие измерения</h3>
